# 30 · 加深 10_flow_cli_session

Open Folder = kimi-code-meta 仓根。帽子 30。
task: docs/tasks/active/task_meta_graph_flow_deepen_cli_v1.md
SPEC: docs/tasks/specs/SPEC_meta_graph_flow_deepen_v1_zh.md §4.2 D1–D8 与 §2.1 `10_flow_cli_session` 行

GATE_VERIFY 首输出。只改 docs/_tech_graph/10_flow_cli_session.graph.yaml 并 compile --graph-id 10_flow_cli_session。
